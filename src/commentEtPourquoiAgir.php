    ...
    <main>
        <section>
            ...
            <article>
                ...
                grâce à nos ressources éducatives et aux outils d'auto-évaluation NR spécialement conçus pour les associations. Ensemble, nous pouvons faire de votre
            ...
            <article>
                ...
                Responsable offre l'opportunité de développer des services numériques accessibles à tou.te.s, tout en soutenant le bien-être de la communauté locale.
                 Nos ressources et outils sont là pour guider votre collectivité dans cette démarche, afin que chaque clic compte pour un avenir durable. 
                </p>
            </article>
            <article>
                ...
                d'amélioration. Engagez-vous dans la transition vers un numérique responsable, cela sera utile pour le futur de votre entreprise aux vues des futures loi qui 
                toucheront tou.te.s les utilisateur.rice.s du numérique, cela réduira aussi les coûts de maintiens dans le long terme ainsi que prôner une meilleure image à vos clients. 
                </p>
            </article>
        </section>
    </main>
