        ...
        <section>
            <?php if ($performances !== "" && $performances !== null): ?>
                ...
                <article>
                    ...
                    <p>
                        <?php echo $performances; ?>
                    </p>
                    <p>
                        <?php echo $texte_performances; ?>
                    </p>
                </article>
                <article>
                    <h3>Accessibilité de votre site :</h3>
                    <p>
                        <?php echo $accessibilite; ?>
                    </p>
                    <p>
                        <?php echo $texte_accessibilite; ?>
                    </p>
                </article>
                <article>
                    <h3>Bonnes pratiques de votre site :</h3>
                    <p>
                        <?php echo $bonnes_pratiques; ?>
                    </p>
                    <p>
                        <?php echo $texte_bonnes_pratiques; ?>
                    </p>
                </article>
                <article>
